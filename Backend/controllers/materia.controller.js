...
export const createMateria = async (req, res)=> { 
    const materia = req.body; // get the materia from the request body

    if (!materia.name || !materia.uc || !materia.profesor || !materia.descripcion || !materia.horario || !materia.aula || !materia.prelacion || !materia.cupomax  || !materia.image ) {
